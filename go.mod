...
// library links only the Apache-2.0 contract (oblikovati.org/api). Add-in<->host
// integration tests against the GPL host module are a future addition, not present in
// this repo today; when they land, the host would be TEST-SCOPE ONLY (go.work / CI
